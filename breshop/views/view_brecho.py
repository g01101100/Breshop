...
class BrechoDatailView(View):
    def get(self, request, pk):
        try:
            ...
            return JsonResponse({'error': 'brecho não encontrado'}, status=404)
    ...
    def put(self, request, pk):
        ...
        brecho.name = name.strip(),
        brecho.email = email.strip(),
        brecho.address = address,
        brecho.phone = phone.strip(),
        brecho.instagram = instagram,
        ...
        return JsonResponse({
            'name': brecho.name,
            'email': brecho.email,
            'address': brecho.address,
            'phone': brecho.phone,
            'instagram': brecho.instagram,
        }, status = 200)
